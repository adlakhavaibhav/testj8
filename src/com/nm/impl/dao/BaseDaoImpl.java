...
public class BaseDaoImpl extends HibernateDaoSupport implements BaseDao {
  ...
  @Autowired
  public void init(@Qualifier("sessionFactory") SessionFactory factory, @Qualifier("hibernateTemplate") HibernateTemplate hibernateTemplate) {
  ...
  */
  ...
  public Object findUniqueByNamedParams(String queryString, String[] params, Object[] values) {
    List results = getHibernateTemplate().findByNamedParam(queryString, params, values);
  ...
  public Object findUnique(String queryString, Object[] binds) {
    ...
    List results = getHibernateTemplate().find(queryString, binds);
  ...
  public Object findUniqueByNamedQueryAndNamedParam(String queryString, String[] paramNames, Object[] paramValues) {
    List results = getHibernateTemplate().findByNamedQueryAndNamedParam(queryString, paramNames, paramValues);
